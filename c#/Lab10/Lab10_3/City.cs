...
namespace Lab10_3
{
    class City
    {
        ...
        public List<string> CultureArea { get; set; }
        ...
        public City(string name, string mayor, int year, string history, string geography, uint population, List<string> culture)
        {
            this.Name = name;
            this.Mayor = mayor;
        ...
        public static void GetOldestCity(List<City> cities)
        {
